...
const handleSubmit = (e: React.FormEvent<HTMLFormElement>)=> {
  ...
  return (
    <form onSubmit={handleSubmit} className='card m-5 px-5 py-2 flex flex-col gap-5' >
      <p className="font-bold text-lg text-blue-500"> Useref test </p>
      <div className="flex gap-5">
      <ToggleIcon initialIcon="eye-slash" toggleIcon="eye" 
                  onClick={handleIcon}/> 
      <input className="focus:outline-1 focus:outline-blue-500 " type="password" ref={inputref} value={input} 

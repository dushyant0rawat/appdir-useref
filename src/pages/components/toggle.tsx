...
type icons = "eye" | "eye-slash" | "user"
type toggleProps = { initialIcon: icons,toggleIcon?:icons,
    onClick:()=>void}
  const ToggleIcon  =  ({initialIcon,toggleIcon=initialIcon,onClick}: toggleProps) => {
